const SETTINGS_HELP={
  de:{
    ...
    'set-max-active':'Begrenzt gleichzeitig sichtbare Raketen. Niedriger = weniger GPU/CPU. Höher = mehr Raketen auf einmal (bis 200).',
    'set-max-pending':'Maximale Gesamt-Warteschlange für Raketen. Bei vielen Angriffen erhöhen (bis 1000).',
    'set-max-batch':'Wie viele neue Raketen pro Tick gestartet werden (bis 100).',
  ...
  en:{
    ...
    'set-max-active':'Limit simultaneous rockets. Lower reduces GPU/CPU. Up to 200.',
    'set-max-pending':'Maximum total queued rockets. Increase for high-traffic servers (up to 1000).',
    'set-max-batch':'How many rockets can start per tick (up to 100).',
