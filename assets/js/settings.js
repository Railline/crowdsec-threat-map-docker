const SETTINGS_HELP={
  de:{
    ...
    'set-rocket-style':'Neu = Verlauf-Schweif, Klassisch = Bogen in Angriffsfarbe, Minimal = kurzer Strich.',
  ...
  en:{
    ...
    'set-rocket-style':'New = gradient tail, Classic = colored arc, Minimal = short segment.',
